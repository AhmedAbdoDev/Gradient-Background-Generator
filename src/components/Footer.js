  ...
  return (
    <footer className="bg-gray-800 text-gray-400 p-8 mt-auto">
      <div className="container mx-auto text-center">
        <div className="mb-4">
          <p className="text-sm leading-relaxed">
            This is a simple and powerful Gradient Background Generator. It's a
            personal project built with Next.js and Tailwind CSS to help
            developers and designers easily create beautiful CSS gradients.
          </p>
        </div>
      ...
      <div className="text-center pt-4 border-t border-gray-700 text-sm">
        &copy; {new Date().getFullYear()} Gradient Generator. All Rights
        Reserved.
      </div>
    </footer>
  );
